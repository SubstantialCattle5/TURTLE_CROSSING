...
class CarManager:
    def __init__(self , level):
        ...
        STARTING_LOCATION = (300 , random.randint(-250 , 250)) #to generate a random starting location of each Car 
    ...
    def move(self): 
        ...
        if self.check == False : 
            ...
            self.car.setx(self.car.xcor() - STARTING_MOVE_DISTANCE - self.level*MOVE_INCREMENT)                
